   ...
   public static void main( String[] args ) {
     try {
	   ...
	   System.out.println( urlList.get(i) );
	      ...
	      resp += s;
           ...
           parseResponse( resp, getCityName( urlList.get(i) ) );
    ...
    public static void parseResponse( String resp, String _cityName ) {
     ...
     try {
       ...
       String nextString = resp.substring(populationIdx,populationIdx+35);
     ...
     try {
       ...
       populationChg = nextString.substring(startIdx+4,endIdx+1).trim();
     } catch ( Exception e ) { e.printStackTrace(); }

     try {
       int medianResIdx = resp.indexOf("Median resident age:");
       String nextString = resp.substring(medianResIdx,medianResIdx+150);
     ...
     try {
       int medianIncomeIdx = resp.indexOf("Estimated median household income");
       String nextString = resp.substring(medianIncomeIdx, medianIncomeIdx+70);
      
       int startIdx = nextString.indexOf(":</b> ");
       int endIdx = nextString.indexOf("(<b>");
       medianHouseholdIncome = nextString.substring(startIdx+5, endIdx).trim();       
     } catch ( Exception e ) { e.printStackTrace(); }

     try {
       int perCapitaIncomeIdx = resp.indexOf("Estimated per capita income");
       String nextString = resp.substring(perCapitaIncomeIdx, perCapitaIncomeIdx+70);
       int startIdx = nextString.indexOf(":</b> ");
     ...
     try {
       int medianHouseValueIdx = resp.indexOf("Estimated median house or condo value");
       String nextString = resp.substring(medianHouseValueIdx, medianHouseValueIdx+90);
       int startIdx = nextString.indexOf("</b>");
       int endIdx = nextString.indexOf("(<b>");
     ...
     try {
       ...
       String nextString = resp.substring(medianRentIdx, medianRentIdx+70);
       int startIdx = nextString.indexOf(":</b>");
       int endIdx = nextString.indexOf(".<br>");
     ...
     try {
       ...
       String nextString = resp.substring(whiteAloneIdx, whiteAloneIdx+60);
       int startIdx = nextString.indexOf("</b>");
     ...
     try {
       ...
       String nextString = resp.substring(americanIndianIdx, americanIndianIdx+50);
       int startIdx = nextString.indexOf("</b>");
       int endIdx = nextString.indexOf("</li>");
     ...
     try {
       ...
       String nextString = resp.substring(nativeHawaiianIdx, nativeHawaiianIdx+50);
       int startIdx = nextString.indexOf("</b>");
       int endIdx = nextString.indexOf("</li>");
     ...
     try {
       ...
       String nextString = resp.substring(costLivingIdx, costLivingIdx+50);
       int startIdx = nextString.indexOf(":</b>");
       int endIdx = nextString.indexOf("<b>");
     ...
     try {
       ...
       String nextString = resp.substring(highSchoolIdx, highSchoolIdx+50);
       int startIdx = nextString.indexOf(":</b>");        
       int endIdx = nextString.indexOf("</li>");
     ...
     try {
       int graduateDegreeIdx = resp.indexOf("Graduate or professional degree");
       String nextString = resp.substring(graduateDegreeIdx, graduateDegreeIdx+60);
       int startIdx = nextString.indexOf(":</b> ");
       int endIdx = nextString.indexOf("</li>");
     ...
     try {
       ...
       String nextString = resp.substring(neverMarriedIdx, neverMarriedIdx+40);
       int startIdx = nextString.indexOf(":</b>");
       int endIdx = nextString.indexOf("</li>");
     ...
     try {
       ...
       String nextString = resp.substring(nowMarriedIdx, nowMarriedIdx+40);
       int startIdx = nextString.indexOf(":</b>");
       int endIdx = nextString.indexOf("</li>");
     ...
     try {
       ...
       String nextString = resp.substring(popDensityIdx, popDensityIdx+40);
       int startIdx = nextString.indexOf(":</b>");
       int endIdx = nextString.indexOf("<b>");
     ...
     System.out.println( "Population 2010 = " + population2010 + "; Males = " + maleCount + "; Females = " + femaleCount + "; PopChg = " + populationChg + "; median age = " + medianAge + "; median Household income = " + medianHouseholdIncome + ";  per capita income = " + perCapitaIncome + "; median House Value = " + medianHouseValue + "; median rent = " + medianRent + "; white alone = " + whiteAlone + "; hispanic = " + hispanic + "; black = " + black + "; american indian = " + americanIndian + "; native hawaiian = " + nativeHawaiian + "; cost of living index = " + costLivingIndex + "; high school = " + highSchool + "; bachelors degree = " + bachelorsDegree + "; graduate degree = " + graduateDegree + "; never married = " + neverMarried + "; now married = " + nowMarried + "; separated = " + separated + "; widowed = " + widowed + "; divorced = " + divorced + "; pop density = " + popDensity + "; land area = " + landArea + "; elevation = " + elevation );  

     try {
       writer.write( "\"" + cityName + "\",\"" + population2010 + "\",\"" + maleCount + "\",\"" + femaleCount + "\",\"" + populationChg + "\",\"" + medianAge + "\",\"" + medianHouseholdIncome + "\",\"" + perCapitaIncome + "\",\"" + medianHouseValue + "\",\"" + medianRent + "\",\"" + whiteAlone + "\",\"" + hispanic + "\",\"" + black + "\",\"" + asian + "\",\"" + americanIndian + "\",\"" + nativeHawaiian + "\",\"" + costLivingIndex + "\",\"" + highSchool + "\",\"" + bachelorsDegree + "\",\"" + graduateDegree + "\",\"" + neverMarried + "\",\"" + nowMarried + "\",\"" + separated + "\",\"" + widowed + "\",\"" + divorced + "\",\"" + popDensity + "\",\"" + landArea + "\",\"" + elevation + "\"\n" );  
     } catch ( IOException ioe ) {
	 ioe.printStackTrace();
     }
   }
